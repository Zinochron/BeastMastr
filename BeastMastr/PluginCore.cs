...
/// <summary>
/// Everything BeastMastr does, built once the shell (<see cref="Plugin"/>) has made sure no other copy of the
/// plugin is doing it too.
/// </summary>
public sealed class PluginCore : IDisposable
{
    ...
    public PluginCore(IDalamudPluginInterface pluginInterface)
    {
